...
import { BsBookmark, BsStar, BsClock, BsLightbulb, BsList } from "react-icons/bs";
...
/>
            ...
            <div>
              ...
              >
                <BsBookmark className={`w-5 h-5 ${isBookSaved ? "fill-current" : ""}`} />
                <span className="text-sm">
                  {isBookSaved ? "In My Library" : isAdding ? "Adding..." : "Add title to My Library"}
                </span>
              </button>
