    ...
    <div className="flex min-h-screen bg-white">
      ...
      <main className="flex-1 ml-64 flex flex-col min-h-screen relative">
        ...
        <div className="flex-1 overflow-y-auto p-8 max-w-4xl mx-auto w-full pb-32">
          <div className="audio__book--summary text-base">
            <div className="audio__book--summary-title font-bold text-xl mb-4 text-[#032b41]">
              {book.title || 'Unknown Title'}
            </div>
            <div className="audio__book--summary-text text-gray-700 leading-relaxed whitespace-pre-line">
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-black px-8 py-3 z-50">
          <audio
            ref={audioRef}
            src={book.audioLink || ''}
          ...
          <div className="flex items-center justify-between h-12">
            ...
            <div className="flex items-center justify-center gap-2">
              ...
              >
                ...
                <span className="absolute inset-0 flex items-center justify-center text-[10px] font-bold pt-0.5">10</span>
              </button>
